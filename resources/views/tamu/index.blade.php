...
<div class="card">
    <div class="card-header">
        ...
        <br><br>
        <a href="{{ route('tamu.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
        <a href="{{ url('tamupdf') }}" class="btn btn-danger"><i class="fas fa-file-pdf"></i> Unduh Buku </a>
        <a class="btn btn-success" href="{{ url('tamucsv') }}"><i class="fa fa-file-excel"></i> Export to CSV</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('tamu.destroy', $tamu->id) }}">
                            ...
                            <a class="btn btn-success" href="{{ route('tamu.edit', $tamu->id) }}"><i class="fa fa-pen-square"></i></a>
